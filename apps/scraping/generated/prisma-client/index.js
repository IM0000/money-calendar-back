...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/scraping/generated/prisma-client",
    "scraping/generated/prisma-client",
  ]
...
path.join(process.cwd(), "apps/scraping/generated/prisma-client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/scraping/generated/prisma-client/schema.prisma")
